...
public class ConvertBase {
  ...
  public static String convertBase(String numAsString, int b1, int b2) {
    int numAsInt = numAsString.substring(numAsString.startsWith("-") ? 1 : 0).chars().reduce(0, (x, c) -> x * b1 + (Character.isDigit(c) ? c - '0' : c - 'A' + 10));
    return (numAsString.startsWith("-") ? "-" : "") + (numAsInt == 0 ? "0" : constructFromBase(numAsInt, b2));
  }
